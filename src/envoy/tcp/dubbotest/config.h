...
#include "src/envoy/tcp/dubbotest/config/metadata_exchange.pb.h"
...
class MetadataExchangeConfigFactory
 ...
 public:
  ...
  std::string name() const override {
    return "envoy.filters.network.dubbo_convert";
  }
...
class MetadataExchangeUpstreamConfigFactory
 ...
 public:
  ...
  std::string name() const override {
    return "envoy.filters.network.upstream.dubbo_convert";
  }
